...
public class FloatingAssistantService extends Service {
  ...
  private void copyCurrentText() {
    ...
    clipboard.setPrimaryClip(ClipData.newPlainText("CookiesTyper", element.optString("text", "")));
  ...
  private void createNotificationChannel() {
    ...
    NotificationChannel channel = new NotificationChannel(
      CHANNEL_ID,
      "CookiesTyper Floating Assistant",
      NotificationManager.IMPORTANCE_LOW
    );
    channel.setDescription("Keeps the CookiesTyper floating assistant available over other apps.");
      ...
      property: [
        {
          $: {
            ...
            'android:value': 'Floating assistant overlay for active CookiesTyper sessions',
          },
        },
      ],
    });
